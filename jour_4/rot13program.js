...
function rot13(arg1) {
    ...
    for (var i = 0; i < arg1.length; i++) {
        var strAscii = arg1.charCodeAt(i);           // on transforme toute la string en code ASCII (ex: A devient 65 etc.)
...
// on applique la fonction à l'argument qui se trouve à l'index 2 de l'array process.argv
