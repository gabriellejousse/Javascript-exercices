...
function displayPrompt() {
    prompt.get(['Card ? type yes or y for a new card'], function (err, result) {

        // si le joueur écrit 'yes' ou 'y', on entre dans ces conditions : 
        if (result['Card ? type yes or y for a new card'] === 'yes' || result['Card ? type yes or y for a new card'] === 'y') {
        ...
        } else if (result['Card ? type yes or y for a new card'] === 'no') {
