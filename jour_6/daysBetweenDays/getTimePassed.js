// ci-dessous, on veut exporter la key fonctionGTP qui se trouve dans l'objet module.exports :
// go to index.js où on importe cette key pour utiliser la fonction getTimePassedfunc dans index.js

module.exports =  {
    fonctionGTP : function getTimePassedfunc(date1, date2) {
